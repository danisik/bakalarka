        ...
        if (sizeof($this->formElementsData['groups']) == 0 && sizeof($this->formElementsData['textareas']) == 0) {
            ...
            foreach($values as $key => $value) {
                ...
                if (strpos($value, "/DV/Off/FT/Btn/Ff 49152/Kids")) {
                    //<</DA(/F3 0 Tf 0.0 0.0 0.4 rg)/DV/Off/FT/Btn/Ff 49152/Kids[262 0 R 265 0 R 268 0 R 271 0 R 274 0 R 277 0 R 280 0 R 283 0 R 286 0 R 289 0 R 292 0 R]/T(group7)/TU(ţ˙)/V/7>>
                    //ACRO PRO
                    ...
                    //<</AP<</N 751 0 R>>/BS<</S/S/W 1>>/DA(/F1 9.9 Tf 0.000 g)/DV()/F 4/FT/Tx/Ff 4198400/H/N/M(D:20190226100627)/MK<</BC[0.6 0.6 0.72]/BG[0.975 0.975 0.975]>>/NM(0295-5091)/P 3 0 R/R 0/Rect[42.52 91.228 552.76 214.978]/Subtype/Widget/T(textarea0)/TU(ţ˙)/Type/Annot/V(Nic)>>
                    //ACRO PRO
                    ...
                    //299 0 obj <</Type /Annot /Subtype /Widget /Rect [42.52 152.382 552.76 276.132 ] /F 4 /FT /Tx /H /N /R 0 /Ff 4198400 /BS <</W 1 /S /S >> /MK <</BC [0.6 0.6 0.72 ] /BG [0.975 0.975 0.975 ] >> /T (textarea4) /TU (ţ˙) /DV () /DA (/F1 9.9 Tf 0.000 g) /NM (0299-5095) /M (D:20190226105951) /V (ţ˙ s h i t t y 5) >> endobj
                    //EVINCE
