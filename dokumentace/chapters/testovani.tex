...
Microsoft Edge, Internet Explorer, Mozilla Firefox, Google Chrome, Safari, Opera
...
% automatické testy ?? + vstupní data + výsledky, webové prohlížeče (tabulka, kde bude vygenerovana verze PDF, zda vše funguje atp.) to samé i u pdf prohlížečů, pdf prohlížeče, popis chyb nalezených při testování, scénář vytvořit pár vstupních dat, vymyslet výsledky a ty nechat "otestovat" uživateli, zda se nahrál soubor se správnými výsledky
